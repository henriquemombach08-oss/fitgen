  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center px-4">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl font-black text-white tracking-tight">FitGen</h1>
        <p className="text-gray-500 text-sm mt-1">Seu personal trainer com IA</p>
      </div>
      ...
      <div className="w-full max-w-sm bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
        ...
        <p className="text-gray-400 text-sm mb-8">
          Faça login para gerar treinos, acompanhar seu histórico e evoluir com IA.
        </p>

        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold text-sm rounded-xl px-4 py-3.5 transition-all duration-200 disabled:opacity-60 shadow-md"
        >
          {loading ? (
